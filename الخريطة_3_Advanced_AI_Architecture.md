...
#### 2. Semantic Concept Mapper (مخطط المفاهيم الدلالية)
```python
class SemanticConceptMapper:
    """رسم خريطة المفاهيم الدلالية للنص"""
...
#### 1. Named Entity Recognition with Arabic BERT
```python
...
class AdvancedEntityRecognizer:
    ...
    def extract_entities(self, text: str) -> Dict[str, List[Dict]]:
        ...
        # Decode entities
        predicted_labels = self.tokenizer.decode(
            torch.argmax(predictions, dim=-1)[0]
        )
...
class RelationExtractor(nn.Module):
    ...
    def _build_entity_graph(self, entities):
        """بناء رسم بياني للكيانات"""
        # Implementation for building entity graph from extracted entities
        pass
