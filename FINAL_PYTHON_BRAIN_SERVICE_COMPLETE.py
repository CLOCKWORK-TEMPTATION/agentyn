...
class FinalAnalysisService:
    ...
    async def analyze_scene_importance(
        ...
        for iteration in range(iterations):
            ...
            scenes = FinalAnalysisService._extract_scenes(text)
            iteration_results = []
            
            for i, scene in enumerate(scenes):
                analysis = FinalAnalysisService._analyze_single_scene(
                    scene, i, iteration, enable_context, context
                )
                
                # التحسين الثوري
                if revolutionary_mode:
                    revolutionary_enhancement = FinalAnalysisService._apply_revolutionary_enhancement(
        ...
        summary = FinalAnalysisService._generate_comprehensive_summary(
